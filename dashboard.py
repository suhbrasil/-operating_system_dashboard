...
class App(customtkinter.CTk):
    ...
    def update_page(self):
        # Method to update the content of the page
        # You can update any widgets or perform any actions here
        
        # For example, let's update the Treeview widget with new data
        processes = self.get_all_processes()
        df = pd.DataFrame.from_dict(processes)
